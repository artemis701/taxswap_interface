...
export const CreateTokenModule = () => {
  ...
  const placeholderdata: JsonObject = {
    ...
    decimals: 6,
    mint: {
      minter: 'taxblock1ehkt6apyy5sxeccw3dfgq8epntn6trfgxgjxtw',
      cap: 9999,
    },
    initial_balances: [
      {
        address: 'taxblock1ehkt6apyy5sxeccw3dfgq8epntn6trfgxgjxtw',
        amount: '9999',
      },
    ],
    marketing: {
      ...
      marketing: 'taxblock1ehkt6apyy5sxeccw3dfgq8epntn6trfgxgjxtw',
      logo: {
